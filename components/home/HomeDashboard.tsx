...
import { ArrowRight, BookOpen, Calculator, Flame, RotateCcw, Sparkles, Zap } from "lucide-react";
...
export function HomeDashboard() {
  ...
  return (
    <main className="mx-auto w-full max-w-md flex-1 p-5 lg:max-w-5xl lg:px-8 lg:py-8">
      {/* 마스코트 인사 */}
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-3 lg:items-start">
        ...
        <div className="flex flex-col gap-5 lg:col-span-2">
          ...
          {/* 실력 진단 — 아직 시작 안 한 사람에게 "건너뛰기" 선택지 제공 */}
          {hydrated && !started && (
            <Link
              href="/diagnostic"
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="block text-sm font-bold">이미 좀 아세요?</span>
        ...
        {/* 우측 레일 — 동기/참고. 데스크탑은 옆, 모바일은 아래로 흐름 */}
